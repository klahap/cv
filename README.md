...
The latest versions of my CV are available in
the [Releases](https://github.com/klahap/cv/releases) section in both
[**German**](https://github.com/klahap/cv/releases/latest/download/cv-german.pdf) and
[**English**](https://github.com/klahap/cv/releases/latest/download/cv-english.pdf).
